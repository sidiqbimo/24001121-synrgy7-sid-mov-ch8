...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public LibrariesForLibs(DefaultVersionCatalog config, ProviderFactory providers, ObjectFactory objects, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) {
        ...
        /**
         * Creates a dependency provider for androidxArchCoreTesting (androidx.arch.core:core-testing)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAndroidxArchCoreTesting() {
            return create("androidxArchCoreTesting");
    }
        ...
        /**
         * Creates a dependency provider for chuclerNoOp (com.github.chuckerteam.chucker:library-no-op)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getChuclerNoOp() {
            return create("chuclerNoOp");
    }
        ...
        /**
         * Creates a dependency provider for hamacrestLibrary (org.hamcrest:hamcrest-library)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getHamacrestLibrary() {
            return create("hamacrestLibrary");
    }
        ...
        /**
         * Creates a dependency provider for hamcrestAll (org.hamcrest:hamcrest-all)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getHamcrestAll() {
            return create("hamcrestAll");
    }
    ...
    public static class AndroidxEspressoLibraryAccessors extends SubDependencyFactory {
        private final AndroidxEspressoIdlingLibraryAccessors laccForAndroidxEspressoIdlingLibraryAccessors = new AndroidxEspressoIdlingLibraryAccessors(owner);
        ...
        /**
         * Returns the group of libraries at androidx.espresso.idling
         */
        public AndroidxEspressoIdlingLibraryAccessors getIdling() {
            return laccForAndroidxEspressoIdlingLibraryAccessors;
        }

    }

    public static class AndroidxEspressoIdlingLibraryAccessors extends SubDependencyFactory {

        public AndroidxEspressoIdlingLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            public Provider<MinimalExternalModuleDependency> getResource() {
                return create("androidx.espresso.idling.resource");
        }
    ...
    public static class AndroidxWorkLibraryAccessors extends SubDependencyFactory {
        ...
        private final AndroidxWorkWorkLibraryAccessors laccForAndroidxWorkWorkLibraryAccessors = new AndroidxWorkWorkLibraryAccessors(owner);
        ...
        /**
         * Returns the group of libraries at androidx.work.work
         */
        public AndroidxWorkWorkLibraryAccessors getWork() {
            return laccForAndroidxWorkWorkLibraryAccessors;
        }
    ...
    public static class AndroidxWorkWorkLibraryAccessors extends SubDependencyFactory {
        private final AndroidxWorkWorkRuntimeLibraryAccessors laccForAndroidxWorkWorkRuntimeLibraryAccessors = new AndroidxWorkWorkRuntimeLibraryAccessors(owner);

        public AndroidxWorkWorkLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at androidx.work.work.runtime
         */
        public AndroidxWorkWorkRuntimeLibraryAccessors getRuntime() {
            return laccForAndroidxWorkWorkRuntimeLibraryAccessors;
        }

    }

    public static class AndroidxWorkWorkRuntimeLibraryAccessors extends SubDependencyFactory {

        public AndroidxWorkWorkRuntimeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             */
            public Provider<MinimalExternalModuleDependency> getKtx() {
                return create("androidx.work.work.runtime.ktx");
        }
    ...
    public static class SquareupLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Returns the group of libraries at squareup.converter
         */
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: androidxArchCoreTestingVer (2.2.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getAndroidxArchCoreTestingVer() { return getVersion("androidxArchCoreTestingVer"); }

            /**
             * Returns the version associated to this alias: androidxWorkRuntimeKtx (2.9.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getAndroidxWorkRuntimeKtx() { return getVersion("androidxWorkRuntimeKtx"); }
            ...
            /**
             * Returns the version associated to this alias: chuckerNoOpVersion (3.5.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getChuckerNoOpVersion() { return getVersion("chuckerNoOpVersion"); }

            /**
             * Returns the version associated to this alias: chuckerVersion (3.5.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getChuckerVersion() { return getVersion("chuckerVersion"); }
            ...
            /**
             * Returns the version associated to this alias: compilerVersion (4.12.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: espressoContribVer (3.5.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getEspressoContribVer() { return getVersion("espressoContribVer"); }
            ...
            /**
             * Returns the version associated to this alias: espressoIdlingResource (3.5.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getEspressoIdlingResource() { return getVersion("espressoIdlingResource"); }

            /**
             * Returns the version associated to this alias: espressoIntentsVer (3.5.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getEspressoIntentsVer() { return getVersion("espressoIntentsVer"); }
            ...
            /**
             * Returns the version associated to this alias: hamcrestAllVer (1.3)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getHamcrestAllVer() { return getVersion("hamcrestAllVer"); }

            /**
             * Returns the version associated to this alias: hamcrestLibraryVer (2.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getHamcrestLibraryVer() { return getVersion("hamcrestLibraryVer"); }

            /**
             * Returns the version associated to this alias: hamcrestVer (2.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getHamcrestVer() { return getVersion("hamcrestVer"); }
            ...
            /**
             * Returns the version associated to this alias: kotlinStdlibVersion (1.9.22)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: kotlinxCoroutinesCore (1.7.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: lifecycleLivedataKtxVersion (2.8.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: lifecycleViewmodelKtxVersion (2.8.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: mockitoKotlinVersion (3.2.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: picassoVersion (2.71828)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: squareupConverterGson (2.9.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
